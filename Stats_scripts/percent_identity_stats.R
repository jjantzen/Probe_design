...
colnames(reshaped_percent_ID)

pdf("Output_figures/percent_ID_vs_exons.pdf")
ggplot(reshaped_percent_ID[which(reshaped_percent_ID$genome != "Miconia" & reshaped_percent_ID$exon.average_length <= 2000),], aes(x = exon.average_length, y = avg_ID_pct))+
